      ...
      >
        ...
        <Script id="meta-pixel" strategy="afterInteractive">
          {`
            ...
            fbq('init', '${process.env.NEXT_PUBLIC_META_PIXEL_ID || "2124473564767754"}');
            fbq('track', 'PageView');
          `}
        </Script>
        <noscript>
          ...
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src={`https://www.facebook.com/tr?id=${process.env.NEXT_PUBLIC_META_PIXEL_ID || "2124473564767754"}&ev=PageView&noscript=1`}
            alt=""
          />
        </noscript>
